...
(function(factory) {
    ...
    editormd.prototype = editormd.fn = {
        ...
        loadQueues: function() {
            ...
            var cmModeIndex = 0,
                cmModeTotal = settings.codemirror.modes.length;
            var cmAddonIndex = 0,
                cmAddonTotal = settings.codemirror.addons.length;
                ...
                if (settings.mathjax) {
                    MathJax.Hub.Queue(function() {
                        previewContainer.find(".mathjax-code").each(function() {
                            ...
                            var mathjaxDoc = $(this).html().replace(/\$\$(.*)\$\$/, function(s1, s2) {
                                return s2;
                            });
        ...
        saveToTextareas: function() {
            ...
            var newMarkdownDoc = editormd.$marked(codeEditor.getValue(), {
